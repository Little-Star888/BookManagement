  ...
  // 4-3 配置主页容器路由
  {
    ...
    children: [
      ...
      // 4-2 配置子路由控制台页面
      {
        path: "control",
        name: "control",
        component: () => import("../views/main/control/ControlView.vue"),
      },
      // 4-2 配置子路由图书借阅管理页面
      {
        path: "borrow",
        name: "borrow",
        component: () => import("../views/main/borrow/BorrowView.vue"),
      },
      // 4-2 配置子路由图书分类管理页面
      {
        path: "category",
      ...
      // 4-2 配置子路由新增图书页面
      {
        path: "addBook",
        name: "addBook",
        component: () => import("../views/main/addBook/AddBook.vue"),
      },
      // 4-2 配置子路由编辑图书页面
      {
        path: "editBook",
        name: "editBook",
        component: () => import("../views/main/editBook/EditBook.vue"),
      },
      // 4-2 配置子路由数据统计分析页面
      {
        path: "count",
        name: "count",
        component: () => import("../views/main/count/CountView.vue"),
      },
      // 4-2 配置子路由系统设置页面
      {
        path: "system",
